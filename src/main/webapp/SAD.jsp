...
<body style="background-color: #EEEEEE">
	...
	<div class="row mr-5 ml-5">
		<div class="col-lg-12 m-auto">
			<p class="d-flex text-justify text-center m-auto5 pl-5 pr-5">The
				standard Lorem Ipsum passage, used since the 1500s "Lorem ipsum
	...
	<div class="align-center text-center pb-5 pt-5">

		<a class="font" href="/News_Paper_Distribution_System/FrontPage.jsp"> <img
