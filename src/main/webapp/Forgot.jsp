			...
			<div
				...
				<div class="col-lg-12 col-xl-11">
					<div class="card text-black"
						...
						<form class="mx-1 mx-md-4" action="Forgot" method="post">
									...
									<div class="row form-outline mb-2">
										...
										<div class="col-lg-10">
											...
											<div class="col-lg-3 mt-3 ml-0 p-0 ">
												<button class="fbtn" type="submit" value="Submit">Submit</button>
											</div>
										</div>
									</div>
...
<script
	...
	<script type="text/javascript">
		...
		if (str == "failed") {
			swal("Sorry", "Please Enter Correct Username or E-mail", "error");
			    }
