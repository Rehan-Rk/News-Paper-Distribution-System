...
<body style="background-color: #eee;">
	...
	<section class="vh-100">
		<div class="container h-100">
			<div
				...
				<div class="col-lg-12 col-xl-11">
					<div class="card text-black"
						...
						<form class="mx-1 mx-md-4" action="Forgot2" method="post">
							<div class="row justify-content-center">
								<div class="col-md-8 col-lg-8 col-xl-7 order-2 order-lg-1">
									<p class="text-center h2 fw-bold mb-5 mx-1 mx-md-4 mt-2">New
										Password</p>
									...
									<div class="row form-outline mb-2">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control form-control-lg"
												name="Npass" placeholder="Enter New Password" />
										</div>
										<div class="col-lg-3 mt-3 ml-0 p-0 ">
											<button class="fbtn" type="submit" value="Submit">Set_Password</button>
										</div>
									</div>
								...
								<div
									...
									<img src="https://i.ibb.co/BL5VhrM/reset.jpg" class="img-fluid"
										alt="Sample image">
			...
			<div class=" col-lg-12 mr-2 mb-3 text-center">
				<a class="font" href="/News_Paper_Distribution_System/Login.jsp"><img
					src="https://img.icons8.com/external-flaticons-flat-flat-icons/30/000000/external-back-web-flaticons-flat-flat-icons.png" />
	...
	<script type="text/javascript">
		var str = document.getElementById("status2").value;
		if (str == "success") {
